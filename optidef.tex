...
This issue has been resolved starting from Optidef 3.0, where the \verb|mini!| environment has been renamed \verb|minie|. The old environment \verb|mini!| will be kept in the library to ensure back-compatibility, but it is recommended to use the \verb|minie| environment to avoid any issue.
...
% Multiple reference
\DeclareDocumentEnvironment{minie}{D||{\defaultProblemFormat} O{0} m m m m}
{\ifthenelse{\equal{#1}{s}}
% Short version problem
...
\DeclareDocumentEnvironment{argminie}{D||{\defaultProblemFormat} O{0} m m m m}
{\ifthenelse{\equal{#1}{s}}
% Short version problem
...
% Multiple reference
\DeclareDocumentEnvironment{maxie}{D||{\defaultProblemFormat} O{0} m m m m}
{\ifthenelse{\equal{#1}{s}}
% Short version problem
...
\DeclareDocumentEnvironment{argmaxie}{D||{\defaultProblemFormat} O{0} m m m m}
{\ifthenelse{\equal{#1}{s}}
% Short version problem
